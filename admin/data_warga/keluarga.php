...
<head>
    ...
    <title>Data Keluarga - <?php echo $desa_nama; ?></title>
    ...
    <div class="main-content">
        ...
        <nav class="top-navbar">
            <div class="d-flex align-items-center">
                ...
                <span class="d-none d-md-inline">Data Keluarga</span>
            </div>
            <div class="user-menu">
                <div class="dropdown">
        ...
        <div class="content-section">
            <div class="section-header">
                <h1 class="section-title">Data Keluarga</h1>
                <div>
                    <a href="tambah-keluarga.php" class="btn btn-primary">
            ...
            <div class="resident-stats">
                <div class="resident-stat-item">
                    ...
                    <p><?php echo number_format($total_keluarga, 0, ',', '.'); ?></p>
                    <small><?php echo number_format($total_keluarga/15, 2); ?> keluarga per RW</small>
                </div>
                <div class="resident-stat-item">
                    <h5>Keluarga Aktif</h5>
                    <p><?php echo number_format($kk_aktif, 0, ',', '.'); ?></p>
                    <small><?php echo round(($kk_aktif/$total_keluarga)*100, 2); ?>% dari total</small>
                </div>
                <div class="resident-stat-item">
                    <h5>Pindah</h5>
                    <p><?php echo number_format($kk_pindah, 0, ',', '.'); ?></p>
                    <small><?php echo round(($kk_pindah/$total_keluarga)*100, 2); ?>% dari total</small>
                </div>
                <div class="resident-stat-item">
                    <h5>Meninggal</h5>
                    <p><?php echo number_format($kk_meninggal, 0, ',', '.'); ?></p>
                    <small><?php echo round(($kk_meninggal/$total_keluarga)*100, 2); ?>% dari total</small>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            <input type="text" class="form-control" placeholder="Cari keluarga..." aria-label="Cari keluarga">
                ...
                <div class="card-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="action-btns">
                                        <a href="detail-keluarga.php" class="btn btn-sm btn-outline-primary" title="Detail">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="edit-keluarga.php" class="btn btn-sm btn-outline-warning" title="Edit">
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge bg-success bg-opacity-10 text-success">Aktif</span></td>
                                    <td class="action-btns">
                                        <a href="detail-keluarga.php" class="btn btn-sm btn-outline-primary">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="edit-keluarga.php" class="btn btn-sm btn-outline-warning">
                                            <i class="fas fa-edit"></i>
                                        </a>
                    ...
                    <div class="pagination-container mt-3">
                        <div class="pagination-info">
                            Menampilkan 1 sampai 3 dari <?php echo number_format($total_keluarga, 0, ',', '.'); ?> data
                        </div>
